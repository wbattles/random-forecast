...
# get city coordinates from csv file
def getCords():
...
# identify weather station in cordinate area, get endpoint for forecast
...
# get city/state listed in weather station data
...
# get short forcast, output with city/state 
